...
// mask and addresses may be the same.
  ...
  #define ws2812_port_set ((uint32_t*)&GPIOC->BSRR)  // Address of the data port register to set the pin
  #define ws2812_port_clr ((uint32_t*)&GPIOC->BRR) // Address of the data port register to clear the pin

  #define ws2812_mask_set  LED_Pin   // Bitmask to set the data out pin
  #define ws2812_mask_clr  LED_Pin   // Bitmask to clear the data out pin
#endif
///////////////////////////////////////////////////////////////////////
